  ...
  return (
    <div className="min-h-screen bg-white text-neutral-950">
      ...
      <main className="mx-auto w-full max-w-4xl px-4 pb-20 pt-10 md:px-6 lg:px-8">
        <section className="rounded-3xl border border-neutral-200 bg-[linear-gradient(145deg,#f9fbf9_0%,#ffffff_65%,#f2f7f2_100%)] p-8 sm:p-10 md:p-12">
          ...
          <div className="mt-8 rounded-2xl border border-neutral-200 bg-white p-6 sm:p-7">
