  ...
  return (
    <div className="min-h-screen bg-[#f5f0e8] text-neutral-950">
      ...
      <main className="mx-auto w-full max-w-6xl px-4 pb-24 pt-10 md:px-6 lg:px-8">
        <div className="relative overflow-hidden bg-[linear-gradient(145deg,#f8faf8_0%,#f5f0e8_56%,#f3f8f4_100%)] p-4 sm:p-6 md:p-8">
          <div className="pointer-events-none absolute -right-10 -top-10 h-52 w-52 bg-emerald-100/65 blur-3xl" aria-hidden="true" />
          <div className="pointer-events-none absolute -bottom-14 -left-8 h-60 w-60 bg-lime-100/55 blur-3xl" aria-hidden="true" />

          <section className="relative grid items-center gap-8 border border-emerald-100/80 bg-[#f5f0e8]/90 p-4 shadow-[0_14px_40px_rgba(16,32,21,0.08)] md:grid-cols-[0.85fr_1.15fr] md:p-6">
            <div className="relative min-h-115 overflow-hidden bg-[#f5f0e8]">
              <Image
            ...
            <div className="border border-neutral-200 bg-[#f5f0e8] p-7 sm:p-10">
          ...
          <section className="relative mt-8 grid items-center gap-8 border border-emerald-100/80 bg-[#f5f0e8]/90 p-4 shadow-[0_14px_40px_rgba(16,32,21,0.08)] md:grid-cols-[1.15fr_0.85fr] md:p-6">
            <div className="border border-neutral-200 bg-[#f5f0e8] p-7 sm:p-10">
